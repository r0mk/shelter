...
for cell in first_col:
    earned = []
    if cell.value and cell.value not in not_needed and len(str(cell.value)) == 8:
        ...
        for day in range(1,32):
            for position in range(0,pos_counter):
                if sheet_ranges[get_column_letter(day + 3)][cell.row + position -1].value:
                    ...
                    worked_days.append(sheet_ranges[get_column_letter(day + 3 )][0].value)
                    #print(worked_days)
                    worked_hours.append(sheet_ranges[get_column_letter(day + 3 )][cell.row + position -1].value)
        try:
            print('{},{},{},1,,1,{}'.format(year,month,cell.value,len(set(worked_days))))
            print('{},{},{},2,,1,{}'.format(year,month,cell.value,round(sum(worked_hours),2)))
            with open('Output.csv','a') as f:
                f.write('{},{},{},1,,1,{}\n'.format(year,month,cell.value,len(set(worked_days))))
                f.write('{},{},{},2,,1,{}\n'.format(year,month,cell.value,round(sum(worked_hours),2)))
        except:
            pass
        #sys.exit()
